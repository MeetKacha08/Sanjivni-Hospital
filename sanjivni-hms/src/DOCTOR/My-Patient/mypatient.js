...
//                                         <button style={labBtn} title='leb'><FaFlask/></button>
...
// import React, { useState, useEffect } from 'react';
// import axios from 'axios';
// import { FaUserCheck, FaPhoneAlt, FaEnvelope, FaUserCircle, FaFilePrescription, FaTimes, FaSave, FaHistory, FaFlask, FaHeartbeat, FaBed, FaSignOutAlt, FaCalendarAlt, FaClock, FaCheckSquare } from 'react-icons/fa';
...
//     const [showLabModal, setShowLabModal] = useState(false);
//     const [availableReports, setAvailableReports] = useState([]);
//     const [selectedTests, setSelectedTests] = useState([]); // 🔥 Track checkbox selections
...
//             {/* --- 🔥 UPDATED: LAB REPORTS MODAL WITH CHECKBOXES --- */}
//             {showLabModal && selectedPatient && (
//                 <div style={modalOverlay}>
//                     <div style={{ ...modalContent, width: '500px', position: 'relative' }}>
//                         <FaTimes
//                             style={{ position: 'absolute', top: '20px', right: '20px', cursor: 'pointer', fontSize: '20px' }}
...
//                                         style={{ marginLeft: '12px', flex: 1, cursor: 'pointer', fontSize: '14px' }}
//                                     >
//                                         {report.reportName}
//                                     </label>
...
//                             }}
//                             onClick={() => {
//                                 alert(`Requesting ${selectedTests.length} tests: ${selectedTests.join(', ')} for ${selectedPatient.fullName}`);
//                                 setShowLabModal(false);
//                             }}
//                         >
...
const Mypatient = () => {
    ...
    // 🔥 NEW: Logic to save the lab request to pandinglabrequest in db.json
    ...
    return (
        <div style={{ padding: '30px', backgroundColor: '#f4f7f6', minHeight: '100vh' }}>
            ...
            {/* --- LAB REPORTS MODAL WITH CHECKBOXES --- */}
            {showLabModal && selectedPatient && (
                <div style={modalOverlay}>
                    <div style={{ ...modalContent, width: '500px', position: 'relative' }}>
                        <FaTimes
                        ...
                        <button 
                            ...
                            onClick={handleLabSubmit} // 🔥 Call the new submission function
                        >
                            <FaCheckSquare style={{ marginRight: '8px' }} /> Submit Selected Tests
                        </button>
                    </div>
