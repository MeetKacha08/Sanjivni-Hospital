...
import axios from 'axios';
import { FaUserCircle, FaCalendarCheck, FaEnvelope, FaPhoneAlt, FaTimes, FaFileAlt, FaDownload, FaHospitalSymbol, FaUserCircle as FaUserIcon, FaProcedures, FaNotesMedical, FaFlask, FaHeartbeat } from 'react-icons/fa';
    ...
    return (
        <div style={{ padding: '30px', backgroundColor: '#f4f7f6', minHeight: '100vh' }}>
            <div style={headerSection}>
                <div>
                    <h2 style={{ margin: 0, color: '#2c3e50' }}>All Patients Master List</h2>
                    <p style={{ color: '#7f8c8d', margin: '5px 0 0 0' }}>Total Registered Records: {patients.length}</p>
                </div>
            </div>
