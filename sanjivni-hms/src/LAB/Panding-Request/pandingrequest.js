...
// import { FaHourglassHalf, FaFlask, FaUserCircle, FaCalendarAlt, FaCheckCircle, FaTimes, FaEdit, FaSave } from 'react-icons/fa';
...
//         try {
//             const res = await axios.get('http://localhost:5000/labOrders');
...
//             await axios.put(`http://localhost:5000/labOrders/${selectedRequest.id}`, updatedData);
...
//                                         {req.assignedReports.map((report, idx) => (
