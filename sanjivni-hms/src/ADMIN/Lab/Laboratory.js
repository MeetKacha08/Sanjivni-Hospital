...
// import { FaPlus, FaMicroscope, FaTimes, FaUserAlt, FaIdCard, FaGraduationCap, FaBriefcase, FaEnvelope, FaPhoneAlt, FaLock, FaEdit, FaTrash, FaFileAlt, FaUsers } from 'react-icons/fa';
...
//     // --- INITIAL STATES ---
//     const initialStaffState = { fullName: '', age: '', contact: '', email: '', education: '', experience: '', loginId: '', password: '' };
...
//     // FIXED: Corrected handleEditClick to ensure it sets the data into the form state
//     const handleEditClick = (item) => {
//         if (item) {
//             setEditFormData({ ...item }); // Spread the item to avoid direct reference
...
//             setSelectedItem(editFormData); // Keep the detail view updated
//             fetchData();
//         } catch (error) { console.error(error); }
//     };
...
//                                         </td>
//                                         <td style={tdStyle}>
//                                             {/* FIXED: Passing report directly to handleEditClick */}
//                                             <FaEdit 
...
//                                     <p style={{ color: '#007bff', fontSize: '18px' }}>Staff Member</p>
//                                     <span style={experienceBadge}>{selectedItem.experience} Experience</span>
//                                 </div>
//                             </div>
//                             <div style={{display: 'flex', gap: '20px', alignItems: 'center'}}>
//                                 {/* FIXED: Passing selectedItem to handleEditClick */}
