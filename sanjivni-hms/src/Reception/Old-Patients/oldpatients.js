...
// import { FaUserCircle, FaCalendarCheck, FaEnvelope, FaPhoneAlt, FaHistory } from 'react-icons/fa';
...
//                         <FaHistory color="#7f8c8d"/> Old Patients Record
//                     </h2>
//                     <p style={{ color: '#7f8c8d', margin: '5px 0 0 0' }}>Total Archived Records: {patients.length}</p>
//                 </div>
//             </div>
...
import axios from 'axios';
import { FaUserCircle, FaCalendarCheck, FaEnvelope, FaPhoneAlt, FaTimes, FaFileAlt, FaDownload, FaHospitalSymbol, FaUserMd, FaHistory } from 'react-icons/fa';
                        ...
                        <div style={{ height: '85vh', overflowY: 'auto', display: 'flex', justifyContent: 'center', padding: '20px' }}>
                            <div ref={reportRef} style={a4PaperStyle}>
                                ...
                                <div style={sectionContainer}>
                                    <h4 style={reportSectionTitle}>ADMISSION HISTORY</h4>
                                    {patientHistory.admission ? (
                                        ...
                                        <div style={noDataStyle}>No admission records found.</div>
                                    )}
                                </div>
